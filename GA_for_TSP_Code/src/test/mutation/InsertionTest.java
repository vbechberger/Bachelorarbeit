...
import tsp.Solution;
import genetic.mutation.Insertion;
...
public class InsertionTest {
	...
	public void testInsertion() {
		mutation = new Insertion(fitnessFct, kid, 1, 4);		
	...
	public void testIndex2SmallerIndex1() {
		mutation = new Insertion(fitnessFct, kid, 1, 0);		
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testIndex2EqualIndex1() {
		mutation = new Insertion(fitnessFct, kid, 1, 1);		
	}
	...
	public void testIndex1TooLarge() {
		mutation = new Insertion(fitnessFct, kid, 8, 1);		
	}
	
	@Test(expected = IndexOutOfBoundsException.class)
	public void testIndex2Negativ() {
		mutation = new Insertion(fitnessFct, kid, 0, -1);		
	}
	
	@Test(expected = IndexOutOfBoundsException.class)
	public void testIndex2TooLarge() {
		mutation = new Insertion(fitnessFct, kid, 0, 10);		
	}
