...
public class TourTest {
	...
	public void testAdjToPath() {
		...
		Assert.assertArrayEquals(expectedPath, adjTour.transformToPathTour().getTourAsArr());
	}
	...
	public void testPathToAdj() {
		...
		Assert.assertArrayEquals(expectedPath, pathTour.transformIntoAdj().getTourAsArr());
	}
